...
module.exports = {
  up: async (queryInterface, Sequelize) => {
    ...
    {"correo_electronico": "carmina@neuroclick.com", "clave_acceso":bcrypt.hashSync("mdeurikflo", Number.parseInt(authConfig.rounds)), "nombre": "Carmina", "apellidos": "Zamora Fernandez", "direccion": "Calle Villamalea, número 26, piso 1, puerta B", "telefono_contacto": "612357806", "rol": "Neuropsicología"},
