...
module.exports = {
  up: async (queryInterface, Sequelize) => {
    ...
    {"correo_electronico": "sandra@neuroclick.com", "clave_acceso":bcrypt.hashSync("32659812", Number.parseInt(authConfig.rounds)), "nombre": "Sandra", "apellidos": "Santa Fernandez", "direccion": "Calle Segovia, número 21, piso 2, puerta 3", "telefono_contacto": "612548744", "rol": "Terapia Ocupacional"},
