...
module.exports = {
  up: async (queryInterface, Sequelize) => {
    await queryInterface.bulkInsert('pruebas', [
      ...
      {"nombre": "Prueba4", "descripcion": "Esta prueba se valora de la siguiente manera: de 0 a 7 (bajo), de 8 a 14 (medio) y de 15 a 21 (bueno).", "profesional": "Terapia Ocupacional"},
      {"nombre": "Prueba5", "descripcion": "Esta prueba se valora de la siguiente manera: de 0 a 3 (bajo), de 4 a 6 (medio) y de 7 a 9 (bueno).", "profesional": "Terapia Ocupacional"},
      {"nombre": "Prueba6", "descripcion": "Esta prueba se valora de la siguiente manera: de 0 a 10 (bajo), de 11 a 20 (medio) y de 21 a 30 (bueno).", "profesional": "Terapia Ocupacional"},
      {"nombre": "Prueba7", "descripcion": "Esta prueba se valora de la siguiente manera: de 0 a 15 (bajo), de 16 a 30 (medio) y de 31 a 45 (bueno).", "profesional": "Terapia Ocupacional"},
